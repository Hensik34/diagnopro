...
-- ==========================================
-- PRE-MIGRATION UPGRADE FOR EXISTING TABLES
-- Ensures all columns exist on legacy tables
-- ==========================================
-- 1. Patients
...
ALTER TABLE settings ADD COLUMN IF NOT EXISTS branch_id UUID UNIQUE;
...
ALTER TABLE time_logs ADD COLUMN IF NOT EXISTS user_id UUID;
ALTER TABLE time_logs ADD COLUMN IF NOT EXISTS clock_in TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE time_logs ADD COLUMN IF NOT EXISTS clock_out TIMESTAMP;
ALTER TABLE time_logs ADD COLUMN IF NOT EXISTS total_hours DECIMAL(5, 2);

-- 4. User Tests
CREATE TABLE IF NOT EXISTS user_tests (id UUID PRIMARY KEY DEFAULT gen_random_uuid());
ALTER TABLE user_tests ADD COLUMN IF NOT EXISTS user_id UUID;
ALTER TABLE user_tests ADD COLUMN IF NOT EXISTS test_id UUID;
ALTER TABLE user_tests ADD COLUMN IF NOT EXISTS test_name TEXT;
ALTER TABLE user_tests ADD COLUMN IF NOT EXISTS category TEXT;
ALTER TABLE user_tests ADD COLUMN IF NOT EXISTS sample_type TEXT;
ALTER TABLE user_tests ADD COLUMN IF NOT EXISTS price NUMERIC;
ALTER TABLE user_tests ADD COLUMN IF NOT EXISTS turnaround_time INTEGER;
ALTER TABLE user_tests ADD COLUMN IF NOT EXISTS description TEXT;

-- 5. Doctors
CREATE TABLE IF NOT EXISTS doctors (id UUID PRIMARY KEY DEFAULT gen_random_uuid());
...
ALTER TABLE reports ADD COLUMN IF NOT EXISTS patient_id UUID;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS doctor_id UUID;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS technician_id UUID;
...
ALTER TABLE reports ADD COLUMN IF NOT EXISTS b2b_lab_id UUID;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS b2b_charge DECIMAL(10,2) DEFAULT 0;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS submitted_by UUID;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS submitted_at TIMESTAMP;
ALTER TABLE reports ADD COLUMN IF NOT EXISTS rejected_by UUID;
...
ALTER TABLE reports ADD COLUMN IF NOT EXISTS branch_id UUID;
