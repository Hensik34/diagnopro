...
'Hemoglobin','g/dL','number','input',
NULL,NULL,
'RBC Parameters',1,
'{"male":{"min":13.0,"max":17.0},"female":{"min":12.0,"max":15.0}}',
'{"low":7.0,"high":20.0}',
true,NOW(),NOW()),

(gen_random_uuid(), (SELECT id FROM tests WHERE test_code='CBC-01'),
'RBC Count','million/uL','number','input',
NULL,NULL,
'RBC Parameters',2,
'{"male":{"min":4.5,"max":5.9},"female":{"min":4.1,"max":5.1}}',
'{"low":2.5,"high":7.0}',
true,NOW(),NOW()),
